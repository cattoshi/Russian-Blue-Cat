...
/* TOM Invite his kind to invade crypto world 
RBCAT is deflationary Token with 2% burn mechanism 🔥
...
contract RBCAT is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20(unicode"Russian Blue Cat", unicode"RBCAT") 
    {
        address supplyRecipient = 0x2a32D9c1D23c3409cb947Ad6ccF684C42802D988;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x2a32D9c1D23c3409cb947Ad6ccF684C42802D988);
        ...
        updateMaxWalletAmount(7000000 * (10 ** decimals()) / 10);

        updateMaxBuyAmount(7000000 * (10 ** decimals()) / 10);
        updateMaxSellAmount(7000000 * (10 ** decimals()) / 10);
        ...
        _transferOwnership(0x2a32D9c1D23c3409cb947Ad6ccF684C42802D988);
    }
